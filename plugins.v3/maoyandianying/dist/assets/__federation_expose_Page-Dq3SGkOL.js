...
const _hoisted_4 = {
  key: 2,
  class: "maoyan-cards-grid"
};
const _hoisted_5 = { style: { "position": "relative" } };
const _hoisted_6 = { class: "d-flex align-center mb-1" };
const _hoisted_7 = { style: { "font-size": "14px", "font-weight": "bold", "line-height": "1.3" } };
const _hoisted_8 = {
...
const _hoisted_16 = { class: "media-header" };
const _hoisted_17 = { class: "media-poster" };
const _hoisted_18 = { class: "w-full h-full" };
const _hoisted_19 = { class: "media-title" };
const _hoisted_20 = { class: "d-flex flex-column flex-lg-row align-items-center align-items-lg-baseline" };
const _hoisted_21 = {
  key: 0,
  class: "text-lg ms-1"
};
const _hoisted_22 = { class: "media-attributes" };
...
const _hoisted_27 = { class: "media-actions" };
const _hoisted_28 = { class: "media-overview" };
const _hoisted_29 = { class: "media-overview-left" };
const _hoisted_30 = {
  key: 0,
  class: "tagline"
};
...
const _hoisted_35 = { class: "crew-name" };
const _hoisted_36 = {
  key: 5,
...
const _hoisted_39 = { class: "cast-name" };
const _hoisted_40 = { class: "cast-character" };
const _hoisted_41 = {
  key: 2,
  class: "text-grey text-body-2"
};
...
const _hoisted_44 = { class: "inline-flex cursor-pointer items-center rounded-full bg-gray-600 px-2 py-1 text-sm text-gray-200 ring-1 ring-gray-500 hover:bg-gray-700" };
const _hoisted_45 = ["href"];
const _hoisted_46 = { class: "inline-flex cursor-pointer items-center rounded-full bg-gray-600 px-2 py-1 text-sm text-gray-200 ring-1 ring-gray-500 hover:bg-gray-700" };
const _hoisted_47 = ["href"];
const _hoisted_48 = { class: "inline-flex cursor-pointer items-center rounded-full bg-gray-600 px-2 py-1 text-sm text-gray-200 ring-1 ring-gray-500 hover:bg-gray-700" };
const _hoisted_49 = { class: "media-overview-right" };
const _hoisted_50 = { class: "media-facts" };
const _hoisted_51 = {
  key: 0,
  class: "media-ratings"
};
...
const _hoisted_53 = { class: "media-fact-value" };
const _hoisted_54 = {
  key: 2,
  class: "media-fact"
};
const _hoisted_55 = { class: "media-fact-value" };
const _hoisted_56 = {
  key: 3,
  class: "media-fact"
};
const _hoisted_57 = { class: "media-fact-value" };
const _hoisted_58 = {
  key: 4,
  class: "media-fact"
};
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_5, [
                            ...
                            _createElementVNode("div", {
                              style: _normalizeStyle(`position: absolute; bottom: 0; left: 0; right: 0; background: ${getStatusColor(item)}; color: white; font-size: 12px; text-align: center; padding: 3px 0; border-bottom-left-radius: 4px; border-bottom-right-radius: 4px;`)
                      ...
                      _createVNode(_component_VCol, {
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", null, [
                            ...
                            item.actors ? (_openBlock(), _createElementBlock("div", _hoisted_12, [
                              _createVNode(_component_VIcon, {
                                size: "small",
                                class: "mr-1"
                              }, {
            ...
            _createVNode(_component_VCard, { class: "media-detail-card" }, {
              default: _withCtx(() => [
                _createVNode(_component_VCardTitle, { class: "d-flex align-center px-4 pt-4 pb-0" }, {
                  default: _withCtx(() => [
                    _createElementVNode("span", _hoisted_13, _toDisplayString((detail.value || selectedItem.value)?.title || selectedItem.value?.name || "媒体详情"), 1),
                    _createVNode(_component_VSpacer),
                    _createVNode(_component_VBtn, {
                      icon: "mdi-close",
                      variant: "text",
                ...
                _createVNode(_component_VCardText, { class: "px-4 pb-4" }, {
                  default: _withCtx(() => [
                    detailLoading.value ? (_openBlock(), _createElementBlock("div", _hoisted_14, [
                      _createVNode(_component_VProgressCircular, {
                        indeterminate: "",
                        color: "primary"
                      }),
                      ...
                      _: 1
                    })) : detail.value ? (_openBlock(), _createElementBlock("div", _hoisted_15, [
                      _createElementVNode("div", _hoisted_16, [
                        ...
                        _createElementVNode("div", _hoisted_19, [
                          ...
                          _createElementVNode("span", _hoisted_22, [
                            ...
                            (detail.value.runtime || detail.value.episode_run_time?.[0]) && detail.value.genres?.length ? (_openBlock(), _createElementBlock("span", _hoisted_24, "|")) : _createCommentVNode("", true),
                            detail.value.genres?.length ? (_openBlock(), _createElementBlock("span", _hoisted_25, _toDisplayString(getGenresName(detail.value.genres)), 1)) : _createCommentVNode("", true)
                          ]),
                      ...
                      _createElementVNode("div", _hoisted_28, [
                        _createElementVNode("div", _hoisted_29, [
                          detail.value.tagline ? (_openBlock(), _createElementBlock("div", _hoisted_30, _toDisplayString(detail.value.tagline), 1)) : _createCommentVNode("", true),
                          detail.value.overview ? (_openBlock(), _createElementBlock("h2", _hoisted_31, "简介")) : _createCommentVNode("", true),
                          detail.value.overview ? (_openBlock(), _createElementBlock("p", _hoisted_32, _toDisplayString(detail.value.overview), 1)) : (_openBlock(), _createElementBlock("p", _hoisted_33, "暂无简介")),
                          detail.value.directors?.length ? (_openBlock(), _createElementBlock("ul", _hoisted_34, [
                            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(detail.value.directors, (director) => {
                              return _openBlock(), _createElementBlock("li", {
                                ...
                                _createElementVNode("span", _hoisted_35, _toDisplayString(director.name), 1)
                              ]);
                            }), 128))
                          ])) : _createCommentVNode("", true),
                          detail.value.tmdb_id ? (_openBlock(), _createElementBlock("div", _hoisted_36, [
                            _cache[23] || (_cache[23] = _createElementVNode("h2", { class: "cast-title" }, "演员阵容", -1)),
                            castLoading.value ? (_openBlock(), _createElementBlock("div", _hoisted_37, [
                              _createVNode(_component_VProgressCircular, {
                                indeterminate: "",
                                color: "primary",
                                size: "small"
                            ...
                            ])) : cast.value.length ? (_openBlock(), _createElementBlock("div", _hoisted_38, [
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(cast.value, (person) => {
                                return _openBlock(), _createElementBlock("div", {
                                  ...
                                  _createElementVNode("div", _hoisted_39, _toDisplayString(person.name), 1),
                                  _createElementVNode("div", _hoisted_40, _toDisplayString(person.character), 1)
                                ]);
                              }), 128))
                            ])) : (_openBlock(), _createElementBlock("div", _hoisted_41, "暂无演员信息"))
                          ])) : _createCommentVNode("", true),
                          _createElementVNode("div", _hoisted_42, [
                            ...
                            ], 8, _hoisted_43)) : _createCommentVNode("", true),
                            ...
                            ], 8, _hoisted_45)) : _createCommentVNode("", true),
                            ...
                            ], 8, _hoisted_47)) : _createCommentVNode("", true)
                          ])
                        ]),
                        _createElementVNode("div", _hoisted_49, [
                          _createElementVNode("div", _hoisted_50, [
                            detail.value.vote_average ? (_openBlock(), _createElementBlock("div", _hoisted_51, [
                            ...
                            detail.value.tmdb_id ? (_openBlock(), _createElementBlock("div", _hoisted_52, [
                              _cache[27] || (_cache[27] = _createElementVNode("span", null, "ID", -1)),
                              _createElementVNode("span", _hoisted_53, _toDisplayString(detail.value.tmdb_id), 1)
                            ])) : _createCommentVNode("", true),
                            detail.value.original_title || detail.value.original_name ? (_openBlock(), _createElementBlock("div", _hoisted_54, [
                              _cache[28] || (_cache[28] = _createElementVNode("span", null, "原始标题", -1)),
                              _createElementVNode("span", _hoisted_55, _toDisplayString(detail.value.original_title || detail.value.original_name), 1)
                            ])) : _createCommentVNode("", true),
                            detail.value.status ? (_openBlock(), _createElementBlock("div", _hoisted_56, [
